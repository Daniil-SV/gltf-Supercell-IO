...
class ScwFile:
	...
	def _read_chunks(self, data: BinaryReader): # TODO: Rename "chunk" naming to "object" (if u want)
		while True:
			...
			match signature:
				case b"HEAD":
					chunk = data.read_struct(ScwHeader, expected_end_offset=expected_end_offset)
